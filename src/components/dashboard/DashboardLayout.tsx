...
import { LayoutDashboard, TrendingUp, Syringe, DollarSign, Settings, LogOut, Package, Briefcase, ShoppingCart, Users, Calendar, User, ChevronDown, Menu, Shield, Scale, ChevronRight, HelpCircle, ListChecks, Crown, Zap, Sprout, Egg, HeartOff, Fish, Rabbit, Waves, Droplets, Beaker, Truck, Heart, Baby, ClipboardList, AlertTriangle } from 'lucide-react';
...
export function DashboardLayout({ children, currentView, onNavigate }: DashboardLayoutProps) {
  ...
  const getNavItems = () => {
    ...
    const aquacultureOnlyItems = new Set(['harvest', 'water-quality', 'sampling', 'stocking', 'fish-health']);
