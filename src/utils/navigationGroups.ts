...
export function getNavigationGroups(
  ...
  const groups: NavigationGroup[] = [
    ...
    },
    {
      id: 'health',
      label: 'HEALTH',
      items: items.filter(item => ['vaccinations', 'mortality', 'weight', 'harvest', 'water-quality', 'sampling', 'stocking', 'fish-health', 'rabbit-harvest', 'breeding-events', 'litters', 'rabbit-registry'].includes(item.id)),
    },
    {
      id: 'money',
      label: 'MONEY',
