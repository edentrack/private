...
export function getNavigationGroups(
  ...
  const groups: NavigationGroup[] = [
    ...
    },
    {
      id: 'health',
      label: 'HEALTH',
      items: items.filter(item => ['vaccinations', 'mortality', 'weight', 'harvest', 'water-quality', 'sampling', 'stocking', 'pond-inspections', 'rabbit-harvest', 'breeding-events', 'litters', 'rabbit-registry'].includes(item.id)),
    },
    {
      id: 'money',
      label: 'MONEY',
