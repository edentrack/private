...
-- Run in Supabase SQL Editor as a one-time fix.
-- =============================================================================

SET LOCAL row_security = off;

-- Step 1: Delete farms owned by users whose email appears in team_invitations.
-- CASCADE removes their farm_members row for that farm; they keep other memberships.
...
-- (Fixes cases where they accepted but the row was missing or lost.)
