/*
  # Fix set_worker_compensation to include rate_amount

  The worker_pay_rates table has rate_amount as NOT NULL.
  This updates the function to populate both old and new schema columns.
*/
